	...
	<div class="app-container">
	    <el-form :model="queryProxyParams" ref="queryProxyRef" size="small" :inline="true" v-show="showProxySearch" label-width="88px">
	     <el-form-item label="分组" prop="groupId">
	      ...
	      <el-form-item label="国家" prop="proxyHost">
	        <el-input v-model="queryProxyParams.proxyHost" placeholder="请输入国家" clearable @keyup.enter.native="handleQueryProxy" />
	      </el-form-item>
	    ...
	    <el-table v-loading="loadingProxy" :data="proxyList" @selection-change="handleSelectionProxyChange">
	      ...
	      <el-table-column label="国家" align="center" prop="proxyHost" />
	    ...
	    <!-- 添加或修改代理对话框 -->
	    <el-drawer :title="titleProxy" :visible.sync="openProxy" size="38%" :append-to-body="true" :destroy-on-close="true">
	      <el-card>
	      <el-form ref="proxyRef" :model="proxyForm" :rules="proxyRules" label-width="98px">
	        ...
	        <el-form-item label="国家" prop="proxyHost">
	          <el-input v-model="proxyForm.proxyHost" placeholder="请输入国家" />
	        </el-form-item>
	        <!-- <el-form-item label="端口" prop="proxyPort">
		...
		<!-- 添加或修改代理对话框 -->
		<el-drawer :title="titleProxy1" :visible.sync="openProxy1" size="38%"  :append-to-body="true" :destroy-on-close="true">
		  <el-card>
		  <el-form ref="proxyRef1" :model="proxyForm" :rules="proxyRules" label-width="98px">
		    <el-form-item label="分组id" prop="groupId">
				<group :my-group-id="queryProxyParams.groupId" :my-group-name="queryProxyParams.groupName" :single="true" @myselect="getGroupIdAndName2"></group>
		    </el-form-item>
  ...
  methods: {
    ...
    handleUpdateProxy(row) {
      ...
      getProxy(id).then(response => {
        this.proxyForm =  Object.assign(this.proxyForm,response.data); ;
        this.openProxy = true;
