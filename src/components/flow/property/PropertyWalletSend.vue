<template>
  <div>
    <el-form label-width="80px" :model="formData">
      ...
      <el-form-item label="输入元素:"  v-if="$props.nodeData.type != 'taskGo' ">
        <el-input v-model="formData.path"></el-input>
      </el-form-item>
	  
	  <el-form-item label="点击元素:"  v-if="$props.nodeData.type != 'taskGo' ">
	    <el-input v-model="formData.path1"></el-input>
	  </el-form-item>
	  
	  <el-form-item label="文本类型:" >
	     <el-select v-model="formData.descType" placeholder="请选择" style="width: 100%;" >
	        <el-option v-for="item in textTypes" :key="item.value" :label="item.label" :value="item.value">
	        </el-option>
	      </el-select>
	  </el-form-item>
	  
		<el-form-item label="文本内容:" v-if="formData.descType != 3 &&  formData.descType != 4 && formData.descType != 5 
			&&  formData.descType != 6 &&  formData.descType != 7 &&  formData.descType != 8 && formData.descType != 9 && formData.descType != 10">
