  ...
  <div>
    <el-form label-width="80px" :model="formData">
	  ...
	  <el-form-item label="操作类型:" >
	     <el-select v-model="formData.operaType" placeholder="请选择" style="width: 100%;" >
	        <el-option v-for="item in operaTypes" :key="item.value"
	          :label="item.label" :value="item.value">
	        </el-option>
	      </el-select>
	  </el-form-item>
	  ...
	  <el-form-item label="数据类型:" >
	     <el-select v-model="formData.dataType" placeholder="请选择" style="width: 100%;" >
	        <el-option v-for="item in dataTypes" :key="item.value"
	          :label="item.label" :value="item.value">
	        </el-option>
	      </el-select>
	  </el-form-item>
